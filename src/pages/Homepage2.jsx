  ...
  return (
    <div>
      ...
      <section style={{
        ...
        {/* Workers image — right half, all 7 visible, navy bg blends with page */}
        <div style={{
          position: 'absolute',
          top: 0,
          right: 0,
          ...
          <img
            src="/Banner Hero/High resolution team image_iq6ghriq6ghriq6g.png"
          ...
          />
          {/* Left fade — seamless since image bg matches page */}
          <div style={{
            position: 'absolute',
            inset: 0,
            background: 'linear-gradient(to right, #071829 0%, rgba(7,24,41,0.3) 18%, transparent 35%)',
            pointerEvents: 'none',
          }} />
        </div>
